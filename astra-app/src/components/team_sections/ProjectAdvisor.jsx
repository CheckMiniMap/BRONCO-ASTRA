...
const ProjectAdvisorSection = () => {
  return (
    ...
    >
      <h1 className="font-poppins font-semibold text-4xl sm:text-5xl">{team.advisor.title}</h1>
      <div className="flex sm:flex-row flex-col sm:items-start items-center w-full gap-5">
        ...
        <p className="text-base md:text-lg"><span className="ml-5"/>{team.advisor.description}</p>
      </div>
    </motion.div>
  )
}
